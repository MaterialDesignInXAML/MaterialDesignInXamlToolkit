...
{
    internal sealed partial class LightTheme : Theme
    {
        //public LightTheme()
        //{
        //    ValidationError = (Color)ColorConverter.ConvertFromString("#B00020");
        //    Background = (Color)ColorConverter.ConvertFromString("#FFFAFAFA");

        //    Card.Background = (Color)ColorConverter.ConvertFromString("#FFFFFFFF");

        //    ToolBar.Background = (Color)ColorConverter.ConvertFromString("#FFF5F5F5");
        //}
