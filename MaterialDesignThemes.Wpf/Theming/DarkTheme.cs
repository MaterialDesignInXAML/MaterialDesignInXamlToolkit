...
{
    internal sealed partial class DarkTheme : Theme
    {
        //public DarkTheme()
        //{
        //    ValidationError = (Color)ColorConverter.ConvertFromString("#FFCF6679");

        //    Background = (Color)ColorConverter.ConvertFromString("#FF303030");

        //    Card.Background = (Color)ColorConverter.ConvertFromString("#FF424242");

        //    ToolBar.Background = (Color)ColorConverter.ConvertFromString("#FF212121");
        //}
